...
#' @param input.delta A nonzero positive integer indicating the window length of the 
#'                    query in months  (if input.frequency="d") or years 
#'                    (if input.frequency="w"). Notice that it will be not used in another case.
